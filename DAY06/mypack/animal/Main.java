...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < 5; i++){
            ...
            System.out.print(filmList[i].getRanking());
        ...
        // Info of film
        System.out.println("In cac film");
        print();
    ...
    public static void findLowestRanking (){
       Double rankFilm[] = new Double[10];
        ...
        Arrays.sort(rankFilm);          // sap xep ranking tang dan | rankFilm[0] la rank thap nhat
           for(int i = 0; i < 10 ; i++) {
            if (rankFilm[0] == filmList[i].getRanking() && i < 5){      // filmList[i] voi i < 5 co rankFilm[0] => movie co chua object rank thap nhat
                System.out.println("Film co ranking thap nhat la: " + movie[i].getRanking());
                System.out.println(movie[i].toString());
            }

            if (rankFilm[0] == filmList[i].getRanking() && i >= 5){     // filmList[i] voi i >= 5 co rankFilm[0] => series co chua object rank thap nhat
    ...
    public static void findDirectorOfLowestComedyRanking () {        //Tim director film type comedy co ranking thap nhat
        ...
        for(int i = 0; i < 10; i++) {
            if (filmList[i].getType() == TYPE.COMEDY && i < 5 && ranking[0] == filmList[i].getRanking()) {      // ranking thap nhat voi i < 5 -> tim trong array movie 
            ...
            if (filmList[i].getType() == TYPE.COMEDY && i >= 5 && ranking[0] == filmList[i].getRanking()) {     // ranking thap nhat voi i >=5  -> tim trong array series
