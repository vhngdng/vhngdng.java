...
public class Main {
    public static void main(String[] args) {
        ...
        employees[0] = new Employee("NV01", "Nguyen Van A", LocalDate.of(1983, 2, 16), Gender.MALE, 20.5);
        employees[1] = new Employee("NV02", "Trinh Van Quyet", LocalDate.of(1989, 9, 11), Gender.MALE, 35.8);
        employees[2] = new Employee("NV03", "Pham Minh Tung", LocalDate.of(1997, 1, 23), Gender.MALE, 10.5);
        employees[3] = new Employee("NV04", "Ha Ngoc My", LocalDate.of(1996, 5, 15), Gender.FEMALE, 45.5);
        employees[4] = new Employee("NV05", "Ho Ngoc Ha", LocalDate.of(2003, 7, 27), Gender.FEMALE, 29.5);
