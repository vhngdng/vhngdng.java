...
public class HomeWorkMySelf {
  public static void main (String[] args){
    ...
    LocalDateTime finishTime = LocalDateTime.of(LocalDate.of(yearFinish, monthFinish, dayFinish), LocalTime.of(hourFinish, minuteFinish));
